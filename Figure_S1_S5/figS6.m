...
%% Search procedure
para_woFB = fmincon(@(x) lossFunc(x, 0.59), 0.5, [], [], [], [], 0, 1);
para_wFB1 = fmincon(@(x) lossFunc(x, 0.55), 0.5, [], [], [], [], 0, 1);
para_wFB2 = fmincon(@(x) lossFunc(x, 0.51), 0.5, [], [], [], [], 0, 1);
