...
load('TD_woFB_FH.mat');
[scale_woFB_td_fh, noise_woFB_td_fh] = bootstrap(allTarget', allResponse', nBootstrap, nBins);

load('TD_woFB_SH.mat');
[scale_woFB_td_sh, noise_woFB_td_sh] = bootstrap(allTarget', allResponse', nBootstrap, nBins);
 
load('TD_wFB1_FH.mat');
[scale_wFB1_td_fh, noise_wFB1_td_fh] = bootstrap(allTarget', allResponse', nBootstrap, nBins);
...
errorbar(0.8, mean(scale_woFB_td_fh, 2), std(scale_woFB_td_fh, 0, 2), '--o', 'LineWidth', 2, 'Color', color1);
errorbar(2.0, mean(scale_woFB_td_sh, 2), std(scale_woFB_td_sh, 0, 2), '--o', 'LineWidth', 2, 'Color', color2);
errorbar(3.2, mean(scale_wFB1_td_fh, 2), std(scale_wFB1_td_fh, 0, 2), '--o', 'LineWidth', 2, 'Color', color3);

plot([0.8, 2, 3.2], mean([scale_woFB_td_fh; scale_woFB_td_sh; scale_wFB1_td_fh], 2), '--', 'LineWidth', 2, 'Color', color2);
...
errorbar(0.8, mean(noise_woFB_td_fh, 2), std(noise_woFB_td_fh, 0, 2), '--o', 'LineWidth', 2, 'Color', color1);
errorbar(2.0, mean(noise_woFB_td_sh, 2), std(noise_woFB_td_sh, 0, 2), '--o', 'LineWidth', 2, 'Color', color2);
errorbar(3.2, mean(noise_wFB1_td_fh, 2), std(noise_wFB1_td_fh, 0, 2), '--o', 'LineWidth', 2, 'Color', color3);

l1 = plot([0.8, 2, 3.2], mean([noise_woFB_td_fh; noise_woFB_td_sh; noise_wFB1_td_fh], 2), '--', 'LineWidth', 2, 'Color', color2);
